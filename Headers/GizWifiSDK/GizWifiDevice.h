...
/**
 ...
 @see GizWifiErrorCode
 */
- (void)device:(GizWifiDevice * _Nonnull)device didReceiveData:(NSError * _Nonnull)result data:(NSDictionary <NSString *, id>* _Nullable)dataMap withSN:(NSNumber * _Nullable)sn;
...
- (void)XPGWifiDevice:(GizWifiDevice * _Null_unspecified)device didReceiveData:(NSDictionary * _Null_unspecified)data result:(int)result DEPRECATED_MSG_ATTRIBUTE("Please use device:didReceiveData:data:withSN: instead") NS_EXTENSION_UNAVAILABLE_IOS("") NS_SWIFT_UNAVAILABLE("");
